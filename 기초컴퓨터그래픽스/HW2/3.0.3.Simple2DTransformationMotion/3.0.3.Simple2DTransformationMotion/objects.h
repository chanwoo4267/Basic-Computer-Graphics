...
#define ACE_LEFT2 2
#define ACE_LEFT3 3
#define DIAMOND_LEFT 4
#define DIAMOND_CENTER 5
#define DIAMOND_RIGHT 6
#define ACE_RIGHT1 7
#define ACE_RIGHT2 8
#define ACE_RIGHT3 9
GLfloat card_body[4][2] = { {-10.0,10.0},{10.0,10.0},{10.0,-10.0},{-10.0,-10.0} };
GLfloat ace_left1[4][2] = { {-7.0, 9.0}, {-7.0, 8.0}, {-8.0, 6.0}, {-8.0, 5.0} };
GLfloat ace_left2[4][2] = { {-7.0, 9.0}, {-7.0, 8.0}, {-6.0, 6.0}, {-6.0, 5.0} };
GLfloat ace_left3[4][2] = { {-7.5, 6.5}, {-7.5,7.5}, {-6.5,6.5 }, {-6.5, 7.5} };
GLfloat diamond_left[4][2] = { {-7.0, 5.0}, {-8.0, 3.5}, {-7.0, 2.0}, {-6.0, 3.5} };
GLfloat diamond_center[4][2] = { {0.0,5.0}, {3.0,0.0}, {0.0,-5.0}, {-3.0,0.0} };
GLfloat diamond_right[4][2] = { {7.0, -5.0}, {8.0, -3.5}, {7.0, -2.0}, {6.0, -3.5} };
GLfloat ace_right1[4][2] = { {7.0, -9.0}, {7.0, -8.0}, {8.0, -6.0}, {8.0, -5.0} };
GLfloat ace_right2[4][2] = { {7.0, -9.0}, {7.0, -8.0}, {6.0, -6.0}, {6.0, -5.0} };
GLfloat ace_right3[4][2] = { {7.5, -6.5}, {7.5,-7.5}, {6.5,-6.5 }, {6.5, -7.5} };
GLfloat card_color[10][3] = {
...
GLuint VBO_card, VAO_card;
void prepare_card() {
	GLsizeiptr buffer_size = sizeof(card_body) + sizeof(ace_left1) + sizeof(ace_left2) + sizeof(ace_left3) + sizeof(diamond_left) + sizeof(diamond_center) + sizeof(diamond_right) + sizeof(ace_right1) + sizeof(ace_right2) + sizeof(ace_right3);

	// Initialize vertex buffer object.
	glGenBuffers(1, &VBO_card);

	glBindBuffer(GL_ARRAY_BUFFER, VBO_card);
	glBufferData(GL_ARRAY_BUFFER, buffer_size, NULL, GL_STATIC_DRAW); // allocate buffer object memory

	glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(card_body), card_body);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body), sizeof(ace_left1), ace_left1);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body) + sizeof(ace_left1), sizeof(ace_left2), ace_left2);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body) + sizeof(ace_left1) + sizeof(ace_left2), sizeof(ace_left3), ace_left3);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body) + sizeof(ace_left1) + sizeof(ace_left2) + sizeof(ace_left3),
		sizeof(diamond_left), diamond_left);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body) + sizeof(ace_left1) + sizeof(ace_left2) + sizeof(ace_left3) + sizeof(diamond_left),
		sizeof(diamond_center), diamond_center);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body) + sizeof(ace_left1) + sizeof(ace_left2) + sizeof(ace_left3) + sizeof(diamond_left) + sizeof(diamond_center),
		sizeof(diamond_right), diamond_right);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body) + sizeof(ace_left1) + sizeof(ace_left2) + sizeof(ace_left3) + sizeof(diamond_left) + sizeof(diamond_center) + sizeof(diamond_right),
		sizeof(ace_right1), ace_right1);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body) + sizeof(ace_left1) + sizeof(ace_left2) + sizeof(ace_left3) + sizeof(diamond_left) + sizeof(diamond_center) + sizeof(diamond_right) + sizeof(ace_right1),
		sizeof(ace_right2), ace_right2);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(card_body) + sizeof(ace_left1) + sizeof(ace_left2) + sizeof(ace_left3) + sizeof(diamond_left) + sizeof(diamond_center) + sizeof(diamond_right) + sizeof(ace_right1) + sizeof(ace_right2),
		sizeof(ace_right3), ace_right3);

	// Initialize vertex array object.
	glGenVertexArrays(1, &VAO_card);
	glBindVertexArray(VAO_card);
...
void draw_card() {
	...
	glUniform3fv(loc_primitive_color, 1, card_color[CARD_BODY]);
	glDrawArrays(GL_TRIANGLE_FAN, 0, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[ACE_LEFT1]);
	glDrawArrays(GL_TRIANGLE_FAN, 4, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[ACE_LEFT2]);
	glDrawArrays(GL_TRIANGLE_FAN, 8, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[ACE_LEFT3]);
	glDrawArrays(GL_TRIANGLE_FAN, 12, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[DIAMOND_LEFT]);
	glDrawArrays(GL_TRIANGLE_FAN, 16, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[DIAMOND_CENTER]);
	glDrawArrays(GL_TRIANGLE_FAN, 20, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[DIAMOND_RIGHT]);
	glDrawArrays(GL_TRIANGLE_FAN, 24, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[ACE_RIGHT1]);
	glDrawArrays(GL_TRIANGLE_FAN, 28, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[ACE_RIGHT2]);
	glDrawArrays(GL_TRIANGLE_FAN, 32, 4);

	glUniform3fv(loc_primitive_color, 1, card_color[ACE_RIGHT3]);
...
//ground
#define GROUND 0
GLfloat ground[4][2] = { { -600.0, 0.0 },{ 600.0, 0.0 },{ 600.0, 200.0 },{ -600.0, 200.0 } };
GLfloat ground_color[1][3] = {
	{ 139 / 255.0f, 120 / 255.0f, 19 / 255.0f }
};
GLuint VBO_ground, VAO_ground;

void prepare_ground() {
	GLsizeiptr buffer_size = sizeof(ground);
...
void draw_ground() {
	...
	glUniform3fv(loc_primitive_color, 1, ground_color[GROUND]);
	glDrawArrays(GL_TRIANGLE_FAN, 0, 4);

	glBindVertexArray(0);
}

GLfloat ground2[4][2] = { { -600.0, 0.0 },{ 600.0, 0.0 },{ 600.0, 200.0 },{ -600.0, 200.0 } };
GLfloat ground2_color[1][3] = {
	{ 50 / 255.0f, 150 / 255.0f, 200 / 255.0f }
};
GLuint VBO_ground2, VAO_ground2;

void prepare_ground2() {
	GLsizeiptr buffer_size = sizeof(ground2);

	// Initialize vertex buffer object.
	glGenBuffers(1, &VBO_ground2);

	glBindBuffer(GL_ARRAY_BUFFER, VBO_ground2);
	glBufferData(GL_ARRAY_BUFFER, buffer_size, NULL, GL_STATIC_DRAW); // allocate buffer object memory

	glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(ground2), ground2);

	// Initialize vertex array object.
	glGenVertexArrays(1, &VAO_ground2);
	glBindVertexArray(VAO_ground2);
...
void draw_ground2() {
	...
	glUniform3fv(loc_primitive_color, 1, ground2_color[GROUND]);
	glDrawArrays(GL_TRIANGLE_FAN, 0, 4);
